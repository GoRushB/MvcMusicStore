...
window.Modernizr = (function( window, document, undefined ) {
    ...
    function webforms() {
        ...
        // Only input place is tested while textarea's place is not.
        // Currently Safari 4 and Opera 11 have support only for the input place
        // Both tests are available in feature-detects/forms-place.js
        Modernizr['input'] = (function( props ) {
            ...
            return attrs;
        })('autocomplete autofocus list place max min multiple pattern required step'.split(' '));
        /*>>input*/
